...
from ._exceptions import APIStatusError, ConnorsPythonMenuError
...
class ConnorsPythonMenu(SyncAPIClient):
    pet: pet.PetResource
    store: store.StoreResource
    user: user.UserResource
    with_raw_response: ConnorsPythonMenuWithRawResponse
    with_streaming_response: ConnorsPythonMenuWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous ConnorsPythonMenu client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("CONNORS_PYTHON_MENU_BASE_URL")
        if base_url is None:
        ...
        self.with_raw_response = ConnorsPythonMenuWithRawResponse(self)
        self.with_streaming_response = ConnorsPythonMenuWithStreamedResponse(self)
...
class AsyncConnorsPythonMenu(AsyncAPIClient):
    pet: pet.AsyncPetResource
    store: store.AsyncStoreResource
    user: user.AsyncUserResource
    with_raw_response: AsyncConnorsPythonMenuWithRawResponse
    with_streaming_response: AsyncConnorsPythonMenuWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncConnorsPythonMenu client instance.
        ...
        self.with_raw_response = AsyncConnorsPythonMenuWithRawResponse(self)
        self.with_streaming_response = AsyncConnorsPythonMenuWithStreamedResponse(self)
...
class ConnorsPythonMenuWithRawResponse:
    def __init__(self, client: ConnorsPythonMenu) -> None:
...
class AsyncConnorsPythonMenuWithRawResponse:
    def __init__(self, client: AsyncConnorsPythonMenu) -> None:
...
class ConnorsPythonMenuWithStreamedResponse:
    def __init__(self, client: ConnorsPythonMenu) -> None:
...
class AsyncConnorsPythonMenuWithStreamedResponse:
    def __init__(self, client: AsyncConnorsPythonMenu) -> None:
...
AsyncClient = AsyncConnorsPythonMenu
